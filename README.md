...
| Company | Role | Highlight | Where |
|---|---|---|---|
| **Lyft** | Data Scientist | Led a 0-to-1 real-time driver incentive system, quadratic optimization · $30M+ annual profit | Remote |
| **NTT Data** | Senior Associate Data Scientist | LoRA fine-tuning + quantization for edge drone inference, multi-agent RAG pipeline | Canada |
| **University of Calgary** | Graduate Research Assistant | Circle RRT\* real-time drone path planner, 11TB+ imagery dataset | Calgary |
| **GNO-SYS Technology** | Software Developer | Deployed Pangeo on AWS, orchestrated 128 containers with Kubernetes | Canada |
| **Beijing Long Fang Wan Fang Tech** | Software & Test Engineer | Modularized signup service, scaled concurrent signups 10x with JUnit coverage | China |
...
![Shell](https://img.shields.io/badge/Shell-0d1117?style=flat&logo=gnubash&logoColor=4EAA25)
...
![Express.js](https://img.shields.io/badge/Express.js-0d1117?style=flat&logo=express&logoColor=white)
...
![Terraform](https://img.shields.io/badge/Terraform-0d1117?style=flat&logo=terraform&logoColor=7B42BC)
